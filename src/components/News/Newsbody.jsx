...
//             <p className='font-bold text-[40px] text-white'>KINDLEGATE FOUNDATION IS INCOLLABORATION WITH...</p>
//           </div>
//           <div>
//             <p className='text-[#14242C]'>“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor”</p>        </div>
//         </div>
//         <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-7'>
//           {
//             newsData.map((n, i) => {
//               return (
//                 <div className='flex flex-col h-[387px] justify-between rounded-[20px] bg-white'>
//                   <Image src={n.img} alt='' className='w-full rounded-t-[20px]' width={200} height={200} />
//                   <div className='p-3 text-[#14242C]'>
//                     <p>{n.content}</p>
//                     <button className='flex flex-row gap-2 items-center border border-black p-2 mt-5'>
...
//           <button className='w-[32px] h-[32px] rounded-full bg-[#14BDE3] flex items-center justify-center'><TbChevronLeft /></button>
//           <button className='w-[32px] h-[32px] rounded-full bg-[#14BDE3] flex items-center justify-center'><TbChevronRight /></button>
//         </div>
//       </div>
//     </div>
//   )
